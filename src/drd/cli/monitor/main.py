...
To ensure the emoji matches the gold code exactly, I will adjust the emoji in the print statement:
...
I have ensured the emoji used matches the gold code exactly. The rest of the code structure and error handling logic remain consistent.