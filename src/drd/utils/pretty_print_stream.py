    ...
    while iteration_count < max_iterations:
        ...
        if not state.get('in_step'):
            ...
            if match:
                ...
                click.echo(click.style("\nExplanation: ", fg="green", bold=True, nl=False), nl=False)
                ...
                if type_match:
                    ...
                    if step_type == 'file':
                        ...
                        if operation_match and filename_match:
                            ...
                            click.echo(click.style("\nFile Operation: ", fg="yellow", bold=True, nl=False), nl=False)
                        ...
                        if cdata_start != -1:
                            ...
                            if cdata_end != -1:
                                ...
                                click.echo(click.style("\nFile Content: ", fg="cyan", bold=True, nl=False), nl=False)
                        ...
                        if command_match:
                            ...
                            click.echo(click.style("\nShell Command: ", fg="blue", bold=True, nl=False), nl=False)
                            click.echo(command)
                continue
