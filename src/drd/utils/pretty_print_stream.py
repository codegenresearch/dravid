                ...
                if type_match:
                    ...
                    if step_type == 'file':
                        ...
                        if operation_match and filename_match:
                            ...
                            click.echo(click.style("File Operation:", fg="yellow", bold=True))
                        ...
                        if command_match:
                            ...
                            click.echo(click.style("Shell Command:", fg="blue", bold=True))
...
def stream_and_print_commands(chunks):
    ...
    if state['buffer'].strip():
        click.echo(f"Remaining Content: {state['buffer'].strip()}")
