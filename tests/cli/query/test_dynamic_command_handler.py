...
class TestDynamicCommandHandler(unittest.TestCase):
    ...
    @patch('drd.cli.query.dynamic_command_handler.print_success')
    @patch('drd.cli.query.dynamic_command_handler.click.echo')
    def test_handle_shell_command_with_empty_output(self, mock_echo, mock_print_success, mock_print_info):
        cmd = {'command': 'echo ""'}
        self.executor.execute_shell_command.return_value = ""
