...
class TestMetadataUpdater(unittest.TestCase):
    ...
    def test_update_metadata_with_dravid(self, mock_asyncio_run, mock_metadata_manager,
        ...
        mock_metadata_manager_instance.add_external_dependency.assert_any_call(
            'requests==2.26.0')
        mock_metadata_manager_instance.add_external_dependency.assert_any_call(
            'react@^17.0.2')
        mock_metadata_manager_instance.add_external_dependency.assert_any_call(
